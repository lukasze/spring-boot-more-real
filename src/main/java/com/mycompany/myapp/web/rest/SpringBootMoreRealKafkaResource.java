...
@RestController
@RequestMapping("/api/spring-boot-more-real-kafka")
public class SpringBootMoreRealKafkaResource {

    private final Logger log = LoggerFactory.getLogger(SpringBootMoreRealKafkaResource.class);
    ...
    public SpringBootMoreRealKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
